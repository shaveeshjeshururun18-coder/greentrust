...
const BackgroundAnimation: React.FC = () => {
    ...
    return (
        <div className="fixed inset-0 -z-10 pointer-events-none overflow-hidden bg-white transition-colors duration-500">
            ...
            {/* 3. Micro-Patterns */}
            <div className="absolute inset-0 opacity-40" style={{ backgroundImage: vegPattern }}></div>

            {/* 2. Abstract Blobs */}
            <div
                className="absolute -top-[10%] -right-[10%] w-[70vw] h-[70vw] md:w-[40vw] md:h-[40vw] bg-gradient-to-br from-green-200/40 to-emerald-200/40 blur-[80px] animate-float-slow rounded-[30%_70%_70%_30%/30%_30%_70%_70%]"
                style={{ transform: `translate(${mousePos.x * -0.5}px, ${mousePos.y * -0.5}px)` }}
            ></div>

            <div
                className="absolute -bottom-[10%] -left-[10%] w-[80vw] h-[80vw] md:w-[45vw] md:h-[45vw] bg-gradient-to-tr from-blue-100/40 to-green-100/40 blur-[100px] animate-float-reverse rounded-[70%_30%_30%_70%/60%_40%_60%_40%]"
                style={{ transform: `translate(${mousePos.x * 0.5}px, ${mousePos.y * 0.5}px)` }}
            ></div>
            ...
            {[...Array(5)].map((_, i) => (
                <div
                    key={i}
                    className="absolute bg-green-400/20 rounded-full blur-[1px] animate-rise"
                    style={{
